  ...
  var ExpandableTable = /*#__PURE__*/function () {
    ...
    _proto.init = function init() {
      $__default["default"](SELECTOR_DATA_TOGGLE$2).each(function (_, $header) {
        var $tr = $__default["default"]($header);
        ...
        var $body = $tr.next(SELECTOR_EXPANDABLE_BODY).children().first().children();
    ...
    _proto.toggleRow = function toggleRow() {
      ...
      var $type = this._element.attr(SELECTOR_ARIA_ATTR);
      ...
      if ($type === 'true') {
        ...
        this._element.attr(SELECTOR_ARIA_ATTR, 'false');

        this._element.trigger($__default["default"].Event(EVENT_COLLAPSED$2));
      } else if ($type === 'false') {
        $element.next(SELECTOR_EXPANDABLE_BODY).removeClass('d-none');
        $body.slideDown(time);

        this._element.attr(SELECTOR_ARIA_ATTR, 'true');

        this._element.trigger($__default["default"].Event(EVENT_EXPANDED$1));
      }
    } // Static
    ;
